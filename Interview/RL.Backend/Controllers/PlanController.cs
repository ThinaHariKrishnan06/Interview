...
public class PlanController : ControllerBase
{
    ...
    [HttpGet("UserPlanProcedure")]
    public IActionResult GetUserPlanProcedure(int PlanId)
    {
        var response = _context.UsersPlanProcedures.Where(x => x.PlanId == PlanId && x.Deleted==false);
