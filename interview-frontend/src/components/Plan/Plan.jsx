...
const Plan = () => {
  ...
  const [usersPlanProcedure, setUsersPlanProcedure] = useState([]);
  ...
  useEffect(() => {
    (async () => {
      ...
      var userplanprocedures = await getUsersPlanProcedures(id);
      ...
      setUsersPlanProcedure(userplanprocedures);
    })();
  }, [id]);
                    ...
                    <div>
                      {planProcedures.map((p) => (
                        <PlanProcedureItem
                          ...
                          planId={id}
                          users={users}
                          selectedUserList={usersPlanProcedure.filter(x => x.procedureId == p.procedure.procedureId)}
                        />
                      ))}
                    </div>
                  </div>
